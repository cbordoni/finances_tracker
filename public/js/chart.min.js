...
!(function (t, e) {
		...
		n = (function (t, e) {
			...
			(a.rgb.hsl = function (t) {
				...
				(a.rgb.hcg = function (t) {
					...
					return (
						(e =
							s <= 0 ? 0 : r === n ? ((i - a) / s) % 6 : r === i ? 2 + (a - n) / s : 4 + (n - i) / s + 4),
						(e /= 6),
				...
				if (s.length) {
					...
					for (
						...
						(n = s[t]._view),
							...
							n.skip ||
								((d !== t - 1 && !o) || -1 === d ? r.moveTo(n.x, n.y) : H.canvas.lineTo(r, e._view, n),
								(d = t));
	...
	var $t = it.extend({
		...
		_resolveDatasetElementOptions: function () {
			...
			return (
				(i.spanGaps = Zt(e.spanGaps, n.spanGaps)), (i.tension = Zt(e.lineTension, n.elements.line.tension)), i
			);
		},
		updateBezierControlPoints: function () {
			var t,
		...
		for (t.beginPath(), o = 0, s = g; o < s; ++o)
			(d = n((u = e[(l = o % g)]._view), l, i)),
				...
				h && c
					...
					: b &&
					  x &&
					  (p ? (h && m.push(u), c && v.push(d)) : (_i(t, m, v, b, x), (b = x = 0), (m = []), (v = [])));
